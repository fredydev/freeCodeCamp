...
* <strong>User:</strong> since Linux is a multi-users based system, it 's common to have different users with his own account. Not only that are called users some services running in background. Informations about the users of the system are located in the “/etc/passwd” file. 
